//
//  SearchDetails1ViewController.swift
//  Athlete
//
//  Created by ali john on 03/12/2024.
//
...
class SearchDetails1ViewController: UIViewController, AVPlayerViewControllerDelegate {
    ...
    private func fetchAllQuestions() {
        ...
        FirebaseData.getCourseQuestionData(courseID: couseData.docId ) { error, courses in
    ...
    func updatecourse(){
        for chapter in courseData.courseOverviewData{
            if let time = chapter.progress[FirebaseData.getCurrentUserId()],time < 100{
                return
            }
        }
...
extension SearchDetails1ViewController:UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            if self.courseData.contentType == "course"{
...
extension SearchDetails1ViewController:UICollectionViewDelegate,UICollectionViewDataSource{
...
extension SearchDetails1ViewController:UITextViewDelegate{
