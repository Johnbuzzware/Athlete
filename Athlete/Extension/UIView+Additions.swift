...
class UIView_Additions: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundColor = UIColor.color(withGradientStyle: .topToBottom, frame: self.frame, colors: [UIColor().colorsFromAsset(name: .blueColor),UIColor().colorsFromAsset(name: .blueColor)])
    }
